package com.example.mainb.presentation.cart.adapter
...
import com.example.mainb.databinding.ItemCartProductOrderBinding
import com.example.mainb.utils.doneEditing
...
class CartViewHolder(
    ...
    private fun setCartData(item: Cart) {
        with(binding) {
            ...
            tvProductPrice.text = (item.itemQuantity * item.productPrice).toIndonesianFormat()
        }
    }
...
class CartOrderViewHolder(
    ...
    private fun setCartData(item: Cart) {
        with(binding) {
            ...
            tvProductName.text = item.productName
            tvProductPrice.text =  item.productPrice.toIndonesianFormat()
        }
    }
